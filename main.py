...
async def stop_cmd(client, message):
    ...
    await m.reply_text("🛑 **Stop Command Received!** Current video ke baad batch ruk jayega.")
    ...
    for i, (name1, url) in enumerate(links):
        ...
        try:
            ...
            if key:
                ...
                dec_file = f"{name}.mp4"
                # DRM Command using Spidy structure
                cmd = (
